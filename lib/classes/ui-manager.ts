...
import {Breakpoints} from '../utils/varies.js';
...
export function getUI() {
  if (!GLOBAL_TINI.ui)
    throw new Error(
      'No UI manager available, please setupUI() or initUI() first!'
    );
  return GLOBAL_TINI.ui as UIManager;
}
...
export async function initUI(
  ...
  if (GLOBAL_TINI.ui) throw new Error('UI manager has been initialized!');
